...
namespace ToyShop.Data.Migrations
{
    ...
    [Migration("20241205225734_OrderNumberMaxLengthIncreased")]
    partial class OrderNumberMaxLengthIncreased
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ToyShop.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4440492c-fe98-4c1e-b304-29947ff97991"),
                            CategoryId = 1,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3507),
                            ShortDescription = "Изработено от плюшена прежда, обезопасени очички на винт и гранулиран пълнеж.",
                            Size = "Височината е около 35см."
                        },
                        new
                        {
                            Id = new Guid("9202f74b-bcb6-4106-a61a-0a69b063bea8"),
                            CategoryId = 2,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3618),
                        ...
                        new
                        {
                            Id = new Guid("8466df5b-1d1d-49ff-bb15-7ef9f9f921e8"),
                            CategoryId = 3,
                            ...
                            Price = 45m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3653),
                            ShortDescription = "Сами е изработен е от плюшена прежда, обезопасени очички и гранулиран пълнеж.",
                            Size = "Висок е малко над 35см."
                        },
                        new
                        {
                            Id = new Guid("d1ae1d43-a16e-4f9e-88b7-07ae7e732044"),
                            CategoryId = 4,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3683),
                        ...
                        new
                        {
                            Id = new Guid("c65680d9-7adb-40da-90b4-c94ed95d6913"),
                            CategoryId = 5,
                            ...
                            Price = 35m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3711),
                        ...
                        new
                        {
                            Id = new Guid("77b37df2-8b94-4133-81e5-02597a7a9fd2"),
                            CategoryId = 12,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3744),
                            ShortDescription = "Одеалцето е изработено от пухкава плюшена прежда.",
                            Size = "Размер 90х90."
                        },
                        new
                        {
                            Id = new Guid("b2eb0c4b-aedf-45cc-a322-0fca4d5d7b15"),
                            CategoryId = 2,
                            ...
                            Price = 50m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3779),
                            ShortDescription = "Това е мечето Ема, готово за предстоящите хладни дни.",
                            Size = "Височината е около 35см"
                        },
                        new
                        {
                            Id = new Guid("60e7d161-473b-475a-8459-35067a7db0b8"),
                            CategoryId = 2,
                            ...
                            Price = 30m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3806),
                            ShortDescription = "Толкова е сладък, че ти идва да не спираш да го гушкаш.",
                            Size = "Височината е около 25см"
                        },
                        new
                        {
                            Id = new Guid("e57a7b75-1392-42c1-b27e-e6b5d95d5f51"),
                            CategoryId = 6,
                            ...
                            Price = 45m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3835),
                            ShortDescription = "Поли е сладък, шарен еднорог готов за игри и много гушкане!",
                            Size = "Височината е около 35см"
                        },
                        new
                        {
                            Id = new Guid("937517b1-db0b-4f66-90c0-ed4d844ff089"),
                            CategoryId = 4,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3883),
                            ShortDescription = "Ето я и сладката Лоли, която е готова за щури игри.",
                            Size = "Лоли е висока около 35см."
                        },
                        new
                        {
                            Id = new Guid("d5667616-fb53-4b9c-80a1-436771594963"),
                            CategoryId = 7,
                            ...
                            Price = 35m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3912),
                            ShortDescription = "Това са малките мишоци, които изработваме съвсем отскоро.",
                            Size = "Височината им е около 25см"
                        },
                        new
                        {
                            Id = new Guid("fa6de76b-eaa7-49ec-90fe-cc921014922f"),
                            CategoryId = 13,
                            ...
                            Price = 20m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3941),
                            ShortDescription = "Малко, симпатично авокадо.",
                            Size = "Височината е около 15см"
                        },
                        new
                        {
                            Id = new Guid("29b6287c-a852-4210-aec2-ab781393837f"),
                            CategoryId = 4,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3965),
                        ...
                        new
                        {
                            Id = new Guid("cfa39287-b4fc-4d44-9db5-63d549493584"),
                            CategoryId = 10,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(3998),
                        ...
                        new
                        {
                            Id = new Guid("16b2294e-149f-48cb-953d-c302705b3d7f"),
                            CategoryId = 10,
                            Description = "Всяка торта се изработва изцяло по желание на малкия рожденик и може да бъде използвана като част от празника в детската градина.",
                            GlobalCategory = 3,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(4032),
                            ShortDescription = "Тортата за всяко дете, любител на животни. Минималният брой парчета е 15.",
                            Size = "Размерът зависи от броят на парчетата."
                        },
                        new
                        {
                            Id = new Guid("9f18b022-0a7a-476b-9577-397a26525f44"),
                            CategoryId = 10,
                            Description = "Всяка торта се изработва изцяло по желание на малкия рожденик и може да бъде използвана като част от празника в детската градина.",
                            GlobalCategory = 3,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(4059),
                            ShortDescription = "Тортата за малките госпожици, които харесват Елза и Анна . Минималният брой парчета е 15.",
                            Size = "Размерът зависи от броят на парчетата."
                        },
                        new
                        {
                            Id = new Guid("7e66c67c-bf3e-442d-b8a6-fa67459512aa"),
                            CategoryId = 11,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(4087),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 20см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("9dd8ef75-51db-4599-bb2a-40c992233ae6"),
                            CategoryId = 11,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(4134),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 20см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("f38a503f-f0d6-47f5-9fd9-8206585b441a"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 30m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(4158),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 18см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("bb51d7e5-33f3-4a81-be0a-e8b949919872"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(4182),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 30см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("71d5c62b-b648-4a11-b7c0-e7e4d59e419d"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(4205),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 30см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("daf11c81-3cbf-4520-b8b6-bcae3e4e644a"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 20m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 6, 0, 57, 34, 443, DateTimeKind.Local).AddTicks(4229),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 18см в диаметър."
                        });
                });
