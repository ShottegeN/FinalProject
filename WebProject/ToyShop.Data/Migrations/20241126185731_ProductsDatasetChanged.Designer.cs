...
namespace ToyShop.Data.Migrations
{
    ...
    [Migration("20241126185731_ProductsDatasetChanged")]
    partial class ProductsDatasetChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ToyShop.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c080fee1-ba3c-4bb6-8df3-3b923346482f"),
                            CategoryId = 1,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(3973),
                            ShortDescription = "Изработено от плюшена прежда, обезопасени очички на винт и гранулиран пълнеж.",
                            Size = "Височината е около 35см."
                        },
                        new
                        {
                            Id = new Guid("6473c952-630a-4b73-badd-f012172c066d"),
                            CategoryId = 2,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4128),
                        ...
                        new
                        {
                            Id = new Guid("18b2ef65-c03c-4cb1-8ee8-87379e0dba90"),
                            CategoryId = 3,
                            ...
                            Price = 45m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4164),
                            ShortDescription = "Сами е изработен е от плюшена прежда, обезопасени очички и гранулиран пълнеж.",
                            Size = "Висок е малко над 35см."
                        },
                        new
                        {
                            Id = new Guid("99bee65a-a7e3-42cd-8c82-888dc384f7b8"),
                            CategoryId = 4,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4195),
                        ...
                        new
                        {
                            Id = new Guid("3b5e7b10-06dc-4a0d-8893-b87186461b98"),
                            CategoryId = 5,
                            ...
                            Price = 35m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4222),
                        ...
                        new
                        {
                            Id = new Guid("952fcef8-b81b-4307-9450-9f3979f4ad61"),
                            CategoryId = 12,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4257),
                            ShortDescription = "Одеалцето е изработено от пухкава плюшена прежда.",
                            Size = "Размер 90х90."
                        },
                        new
                        {
                            Id = new Guid("b182715b-40bd-44a7-b1fe-c30ae55e6cb8"),
                            CategoryId = 2,
                            ...
                            Price = 50m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4293),
                            ShortDescription = "Това е мечето Ема, готово за предстоящите хладни дни.",
                            Size = "Височината е около 35см"
                        },
                        new
                        {
                            Id = new Guid("e6859ee5-e8a5-4f3e-8d1b-e61ac82245ee"),
                            CategoryId = 2,
                            ...
                            Price = 30m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4321),
                            ShortDescription = "Толкова е сладък, че ти идва да не спираш да го гушкаш.",
                            Size = "Височината е около 25см"
                        },
                        new
                        {
                            Id = new Guid("704a005d-9133-433f-904d-e5c7245beaba"),
                            CategoryId = 6,
                            ...
                            Price = 45m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4379),
                            ShortDescription = "Поли е сладък, шарен еднорог готов за игри и много гушкане!",
                            Size = "Височината е около 35см"
                        },
                        new
                        {
                            Id = new Guid("21b1f0bb-2389-42c6-aee0-2958470c83a9"),
                            CategoryId = 4,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4408),
                            ShortDescription = "Ето я и сладката Лоли, която е готова за щури игри.",
                            Size = "Лоли е висока около 35см."
                        },
                        new
                        {
                            Id = new Guid("01354203-9dfe-4052-bcdc-894a0b6223fb"),
                            CategoryId = 7,
                            ...
                            Price = 35m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4439),
                            ShortDescription = "Това са малките мишоци, които изработваме съвсем отскоро.",
                            Size = "Височината им е около 25см"
                        },
                        new
                        {
                            Id = new Guid("dfe4b4dc-41a9-431c-9b7a-5ee2dd33782a"),
                            CategoryId = 13,
                            ...
                            Price = 20m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4468),
                            ShortDescription = "Малко, симпатично авокадо.",
                            Size = "Височината е около 15см"
                        },
                        new
                        {
                            Id = new Guid("1fbb660d-8fab-4baf-8634-5d036dd8eaac"),
                            CategoryId = 4,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4493),
                        ...
                        new
                        {
                            Id = new Guid("44cc6a92-c92c-4380-a463-2c21e282a5a2"),
                            CategoryId = 10,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4525),
                        ...
                        new
                        {
                            Id = new Guid("30fb63eb-b0ba-4c0a-bdbb-d6699bf68ead"),
                            CategoryId = 10,
                            Description = "Всяка торта се изработва изцяло по желание на малкия рожденик и може да бъде използвана като част от празника в детската градина.",
                            GlobalCategory = 3,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4557),
                            ShortDescription = "Тортата за всяко дете, любител на животни. Минималният брой парчета е 15.",
                            Size = "Размерът зависи от броят на парчетата."
                        },
                        new
                        {
                            Id = new Guid("e4823ca1-4a44-4718-b3f0-9674ed059e3b"),
                            CategoryId = 10,
                            Description = "Всяка торта се изработва изцяло по желание на малкия рожденик и може да бъде използвана като част от празника в детската градина.",
                            GlobalCategory = 3,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4585),
                            ShortDescription = "Тортата за малките госпожици, които харесват Елза и Анна . Минималният брой парчета е 15.",
                            Size = "Размерът зависи от броят на парчетата."
                        },
                        new
                        {
                            Id = new Guid("e7cc1b77-695c-49ab-a1a8-7dd0d5c20502"),
                            CategoryId = 11,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4639),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 20см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("48a4ae8d-4beb-42ab-a7b1-56c5aada8f9c"),
                            CategoryId = 11,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4669),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 20см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("bf192eb7-7e5c-4ca7-9aa1-4bed0663a9c0"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 30m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4696),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 18см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("a3aa852c-ed16-4da0-a86e-af27fa094462"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4720),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 30см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("7e0f3143-2cd1-4340-810e-60a5f7723d5e"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4744),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 30см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("29cb31fa-0e81-4138-a6d5-268c0743c507"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 20m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 11, 26, 20, 57, 30, 691, DateTimeKind.Local).AddTicks(4768),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 18см в диаметър."
                        });
                });
