...
namespace ToyShop.Data.Migrations
{
    ...
    [Migration("20241201110413_RemovingUnusedEntities")]
    partial class RemovingUnusedEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ToyShop.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2e4cec86-1cec-4e81-bef2-5c695c4f4ce7"),
                            CategoryId = 1,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4593),
                            ShortDescription = "Изработено от плюшена прежда, обезопасени очички на винт и гранулиран пълнеж.",
                            Size = "Височината е около 35см."
                        },
                        new
                        {
                            Id = new Guid("b10391cf-4edc-4b5e-aa6a-26b7f536c43f"),
                            CategoryId = 2,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4737),
                        ...
                        new
                        {
                            Id = new Guid("1b59fc28-3801-440f-a258-eaf2d7717ede"),
                            CategoryId = 3,
                            ...
                            Price = 45m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4771),
                            ShortDescription = "Сами е изработен е от плюшена прежда, обезопасени очички и гранулиран пълнеж.",
                            Size = "Висок е малко над 35см."
                        },
                        new
                        {
                            Id = new Guid("c8a265be-dde0-4b3a-8ee6-9cd1f41a5c12"),
                            CategoryId = 4,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4802),
                        ...
                        new
                        {
                            Id = new Guid("90b51dc7-08a3-44c9-9fc2-52ba5a12c72d"),
                            CategoryId = 5,
                            ...
                            Price = 35m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4828),
                        ...
                        new
                        {
                            Id = new Guid("294583f4-a3eb-4806-8a6d-387b248e1896"),
                            CategoryId = 12,
                            ...
                            PromotionId = 1,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4862),
                            ShortDescription = "Одеалцето е изработено от пухкава плюшена прежда.",
                            Size = "Размер 90х90."
                        },
                        new
                        {
                            Id = new Guid("11568a80-d6d2-4c1f-85be-65ed44d64368"),
                            CategoryId = 2,
                            ...
                            Price = 50m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4904),
                            ShortDescription = "Това е мечето Ема, готово за предстоящите хладни дни.",
                            Size = "Височината е около 35см"
                        },
                        new
                        {
                            Id = new Guid("4428873b-ec06-4a1b-8074-ec9632ab8e01"),
                            CategoryId = 2,
                            ...
                            Price = 30m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4932),
                            ShortDescription = "Толкова е сладък, че ти идва да не спираш да го гушкаш.",
                            Size = "Височината е около 25см"
                        },
                        new
                        {
                            Id = new Guid("6b68d7a0-ff62-4d37-93cb-46e4cc7b3ac7"),
                            CategoryId = 6,
                            ...
                            Price = 45m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(4991),
                            ShortDescription = "Поли е сладък, шарен еднорог готов за игри и много гушкане!",
                            Size = "Височината е около 35см"
                        },
                        new
                        {
                            Id = new Guid("7637e255-566c-499e-b7fd-8ef5e82af269"),
                            CategoryId = 4,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5019),
                            ShortDescription = "Ето я и сладката Лоли, която е готова за щури игри.",
                            Size = "Лоли е висока около 35см."
                        },
                        new
                        {
                            Id = new Guid("60d59ade-a2b0-4fa4-8c89-8c96169e3b80"),
                            CategoryId = 7,
                            ...
                            Price = 35m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5048),
                            ShortDescription = "Това са малките мишоци, които изработваме съвсем отскоро.",
                            Size = "Височината им е около 25см"
                        },
                        new
                        {
                            Id = new Guid("e52c0fa0-9d84-4abd-8711-22f1741ccb8b"),
                            CategoryId = 13,
                            ...
                            Price = 20m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5076),
                            ShortDescription = "Малко, симпатично авокадо.",
                            Size = "Височината е около 15см"
                        },
                        new
                        {
                            Id = new Guid("c30a53da-0513-4f2e-afa0-856be4b83872"),
                            CategoryId = 4,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5101),
                        ...
                        new
                        {
                            Id = new Guid("a73287c7-7ba0-43cb-a2c4-22bd0fc08cbb"),
                            CategoryId = 10,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5134),
                        ...
                        new
                        {
                            Id = new Guid("1f09c996-9728-4f4b-958a-26f9d7f7c2e3"),
                            CategoryId = 10,
                            Description = "Всяка торта се изработва изцяло по желание на малкия рожденик и може да бъде използвана като част от празника в детската градина.",
                            GlobalCategory = 3,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5167),
                            ShortDescription = "Тортата за всяко дете, любител на животни. Минималният брой парчета е 15.",
                            Size = "Размерът зависи от броят на парчетата."
                        },
                        new
                        {
                            Id = new Guid("f59517b2-9884-4f15-9897-19d49c9b14f4"),
                            CategoryId = 10,
                            Description = "Всяка торта се изработва изцяло по желание на малкия рожденик и може да бъде използвана като част от празника в детската градина.",
                            GlobalCategory = 3,
                            ...
                            PromotionId = 5,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5194),
                            ShortDescription = "Тортата за малките госпожици, които харесват Елза и Анна . Минималният брой парчета е 15.",
                            Size = "Размерът зависи от броят на парчетата."
                        },
                        new
                        {
                            Id = new Guid("4e85d724-8073-46aa-a095-4d96120c1a31"),
                            CategoryId = 11,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5252),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 20см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("31531462-67c7-456a-8c6f-961ce7378dea"),
                            CategoryId = 11,
                            ...
                            Price = 25m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5281),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 20см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("068855f5-f4fa-4989-a693-a2eae8daa2e7"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 30m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5306),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 18см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("47c32443-7d7d-486c-83df-cc96b14981e5"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5330),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 30см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("4a61c82d-4a8c-47c6-b90d-473e9e6d6331"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 40m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5354),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 30см в диаметър."
                        },
                        new
                        {
                            Id = new Guid("c6658d1a-3260-4212-8c20-81e2795e795d"),
                            CategoryId = 11,
                            Description = "Всяка декорация се изработва изцяло по желание на клиента и може да бъде се използвана като декорация в дома или офиса.",
                            GlobalCategory = 2,
                            ...
                            Price = 20m,
                            Quantity = 5,
                            ReleasedOn = new DateTime(2024, 12, 1, 13, 4, 12, 846, DateTimeKind.Local).AddTicks(5378),
                            ShortDescription = "Красив и стилен подарък, дори с ограничен бюджет.",
                            Size = "Размерът e около 18см в диаметър."
                        });
                });
